...
public class Main {
	...
	public static void main(final String[] args) {
		...
		options.addOption(OptionBuilder.hasArg().withArgName("rp").withLongOpt("recombination")
				.withDescription("Recombination propability [default: 0.8]").withType(Double.valueOf(0)).create("r"));
		...
		options.addOptionGroup(new OptionGroup().addOption(
				OptionBuilder.withLongOpt("verbose").withDescription("be extra verbose").create("v")).addOption(
				OptionBuilder.withLongOpt("quiet").withDescription("be extra quiet").create("q")));
